...
class Task(TaskV):
    ...
    def day_tweet_stat(self,):
        ...
        for row in day_tweet_rs.rows:
            doc.setdefault(row.key, row.value)
    ...
    def hour_user_stat(self, ):
        ...
        db = self._conn[self._hour_dbstr]
